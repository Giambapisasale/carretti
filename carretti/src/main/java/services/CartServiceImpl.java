...
public class CartServiceImpl implements CartService {
	...
	public Carrello getCartBySessionId(String sessionId) throws Exception {
		...
		if( stored_cart != null) {
			System.out.println("*[CartServiceImpl]* Trovato Carrello Salvato con Id  " + stored_cart.getId());
			return stored_cart;
		} else {
			Random randomGenerator = new Random();
			Carrello newCart = new Carrello();
			newCart.setId(randomGenerator.nextInt(100));
			System.out.println("*[CartServiceImpl]* Generato nuovo Carrello con Id  " + newCart.getId());
			return newCart;
		}
	}
